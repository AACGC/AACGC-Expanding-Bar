...
$expbar_online .= "<b><u>".FBAR_04."</u>:</b>
<br/>
".FBAR_05.": ".MEMBERS_ONLINE."
<br/>";
...
if ($userimage == ""){
$useravatar = "<img width='20px' src='".e_PLUGIN."aacgc_expbar/images/default.png' alt='Avatar' />";}
else
{$userimage = str_replace(" ", "%20", $userimage);
include_once(e_HANDLER."avatar_handler.php");  
$userimage = avatar($userimage);
$useravatar = "<img width='20px' src='".$userimage."' alt='Avatar' />";}
...
if ($isadmin){
$userpage = "news.php" ;
$page = " <img src='".e_PLUGIN."aacgc_expbar/images/admin.png'></img>";}

		    
$expbar_online .= "<a href='".e_BASE."user.php?id.".$userid."'>".$useravatar."".$username."</a> - <a href='".$userpage."'>".$page."</a><br>";}

//-------# Guests #-----+

$expbar_online .= "<br>".FBAR_09.": ".GUESTS_ONLINE."<br>";
...
$bot = "<img src='".e_PLUGIN."aacgc_expbar/images/robots/".$boticon."' alt='".$host."' />".$webbot."";
...
$expbar_online .= "".$guest." - <a href='".$guestpage."'>".$gpage."</a><br>";}
